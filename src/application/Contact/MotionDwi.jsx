...
import { BsWhatsapp, BsTelegram, BsTwitter } from "react-icons/bs";
import { FadeIn } from "@/components/FadeIn";

export default function MotionDwi() {
  /* State */
        ...
        <div className="grid">
          ...
          <div className=" pb-10 md:pb-12">
            ...
            <motion.span className="block md:-mb-1 mx-auto text-center text-sm md:text-lg text-gray-800 dark:text-white/70">
              Leader Project <br />
              FullStack Developer/Website/Hosting
            </motion.span>
          </div>
              ...
              <div className="mb-6 text-xs sm:text-lg space-y-3 text-gray-900 dark:text-white">
                <FadeIn>
                  <div className="flex flex-grow bg-gradient-to-br m-2 h-12 from-teal-300 via-sky-800 to-teal-700 p-2 items-center gap-2 border-2 border-blue-900 rounded-xl">
                    <a href="https://t.me/Sidolapak" target="_blank">
                ...
                <FadeIn>
                  <div className="flex flex-grow bg-gradient-to-br m-2 h-12 from-teal-300 via-sky-800 to-teal-700 p-2 items-center gap-2 border-2 border-blue-900 rounded-xl">
                    <a href="https://api.whatsapp.com/send/?phone=6285783024799&text=Hallo%2C%20Tim%20Indatechno.%20Saya%20ingin%20berkomunikasi%20lebih%20lanjut" target="_blank">
                      <p className="flex flex-row pr-2 text-white font-semibold">
                        <BsWhatsapp
                          title="whatsapp"
                          role="button"
                ...
                <FadeIn>
                  <div className="flex bg-gradient-to-br m-2 h-12 from-teal-300 via-sky-800 to-teal-700 p-2 items-center gap-2 border-2 border-blue-900 rounded-xl">
                    <a href="https://www.facebook.com/dwieansh" target="_blank">
                      <p className="flex flex-row pr-2 text-white font-semibold">
                        <Facebook
                          title="Facebook"
                          role="button"
                ...
                <FadeIn>
                  <div className="flex bg-gradient-to-br m-2 h-12 from-teal-300 via-sky-800 to-teal-700 p-2 items-center gap-2 border-2 border-blue-900 rounded-xl">
                    <a href="https://www.instagram.com/dwieansh" target="_blank">
                      <p className="flex flex-row pr-2 text-white font-semibold">
                        <Instagram
                          title="instagram"
                          role="button"
                ...
                <FadeIn>
                  <div className="flex bg-gradient-to-br m-2 h-12 from-teal-300 via-sky-800 to-teal-700 p-2 items-center gap-2 border-2 border-blue-900 rounded-xl">
                    <a href="https://twitter.com/sidolapak" target="_blank">
                      <p className="flex flex-row pr-2 text-white font-semibold">
                        <BsTwitter
                          title="twitter"
                          role="button"
                          name="stars-outline"
                          className="text-white h-7 w-7 p-1 bg-sky-500 rounded-sm mr-3"
                        />
                        Twitter Official
                      </p>
                    </a>
