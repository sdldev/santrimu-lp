  ...
  return (
    <>
      ...
      >
          ...
          <h2 className="text-gray-300 xl:text-5xl md:text-4xl text-xl">Aplikasi Terpadu Santri Boarding School</h2>
      ...
      >
        <h3 className="text-gray-300 text-sm text-center">
          Aplikasi Satri-MU digagas untuk memenuhi 
          kebutuhan management dan sistem informasi pondok, baik untuk pengelola, yayasan, maupun wali santri untuk wali santri 
          </h3>
