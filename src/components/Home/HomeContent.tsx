    ...
    <>
      ...
      >
          <h1 className="mx-2 xl:text-[82px] md:text-[70px] text-[32px] font-bold">
            Santri <span className="text-warning">MU</span> 
          </h1>
          <h2 className="text-warning xl:text-5xl md:text-4xl text-xl">Aplikasi Terpadu Santri Boarding School</h2>
      ...
      >
        <h3 className="text-sm text-center">Company Profil, LandingPage, CMS, dan Aplikasi Berbasis Web</h3>
      </motion.div>
    </>
  );
};
